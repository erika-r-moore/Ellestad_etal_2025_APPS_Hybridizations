...
author: "Paige A. Ellestad, Erika R. Moore-Pollard, Carolina M. Siniscalchi, Ramhari Thapa, Linda E. Watson, J. Mauricio Bonifacino, Jennifer R. Mandel"
#date: "`r Sys.Date()`"
output: 
...
# Preparing genome sequence data 
...
### Running RAxML for pseudo-coalescent analyses
...
```{r phyparts_new, echo=FALSE, fig.cap="Phylogenetic discordance visualized using PhyParts with the new python script adding an additional pie slice separating uninformative to informative genes", out.width = '100%'}
knitr::include_graphics("Images/phyparts_new.pdf")
```
